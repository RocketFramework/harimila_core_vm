                                    ...
                                    <tbody>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding-bottom:40px;color:#606060;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:150%;text-align:center" align="center" valign="middle">
                                                                <h1 style="color:#202020!important;font-family:Helvetica,Arial,sans-serif;font-size:26px;font-weight:bold;letter-spacing:-1px;line-height:115%;margin:0;padding:0;text-align:center"><?php esc_html_e( 'Thank You For Registering', 'adifier'); ?></h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="color:#606060;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:150%;padding-top:40px;padding-right:40px;padding-bottom:20px;padding-left:40px;text-align:center" align="center" valign="top">
                                               <?php esc_html_e( 'Welcome to our platform, only one step remains', 'adifier' ); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:bold;line-height:100%" align="center" valign="middle">
                                                                <a href="<?php echo esc_url( $link ) ?>" style="color:<?php echo adifier_get_option( 'main_color_font' ); ?>;text-decoration:none;padding-top:15px;padding-right:20px;padding-bottom:15px;padding-left:20px;display:block;" target="_blank"><?php esc_html_e( 'Confirm Email', 'adifier' ) ?></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
