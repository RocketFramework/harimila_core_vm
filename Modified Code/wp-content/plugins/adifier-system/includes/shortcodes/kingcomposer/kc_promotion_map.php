...
?>
<div class="search-map" style="<?php echo !empty( $height ) ? esc_attr( 'height: '.$height ) : esc_attr(''); ?>" data-latitude="<?php echo esc_attr( $latitude ) ?>" data-longitude="<?php echo esc_attr( $longitude ) ?>" data-zoom="<?php echo esc_attr( $zoom ) ?>">
<?php
